...
const SomosUteg: NextPageWithLayout = ({ sections, meta }: any) => {
    ...
    <HeaderFooterLayout breadcrumbs={true}>
      <ContentLayout>
        ...
        <div className="col-span-12 w-t:col-span-8 w-p:col-span-4 mt-12 w-t:mt-6 w-p:mt-6">
          <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%]">{sections?.history?.title}</p>
        </div>
        <div className="col-span-6 w-t:col-span-8 w-p:col-span-4">
          <Image
      ...
      <ContentFullLayout classNames="bg-[#1B2D68] w-d:py-12 text-surface-0 mt-18 w-t:mt-3 w-p:mt-3">
        <ContentLayout classNames="w-d:my-6 flex items-center">
          <div className="col-span-6 w-t:col-span-8 w-p:col-span-4 w-t:mt-6 w-p:mt-6 w-d:my-auto">
            <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%]">{sections?.missionAndVission?.title}</p>
      ...
      <ContentLayout classNames="mt-12 w-t:mt-6 w-p:mt-6">
        <div className="col-span-6 w-t:col-span-8 w-p:col-span-4 my-auto">
          <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%]">{sections?.ourValues?.title}</p>
          {
        ...
        <div className="col-span-12 w-t:col-span-8 w-p:col-span-4 mt-12 w-t:mt-6 w-p:mt-6">
          <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%]">{sections?.community?.title}</p>
        </div>
        ...
        <div className="col-span-12 w-t:col-span-8 w-p:col-span-4 mt-12 w-t:mt-6 w-p:mt-6">
          <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%] mb-6">{sections?.ourScholarships?.title}</p>
        </div>
        <div className="w-d:col-span-12 w-t:col-span-8 w-p:col-span-4 grid w-d:grid-cols-3 gap-6 w-t:grid-cols-2 w-p:grid-cols-1">
          {
      ...
      <ContentLayout>
        <div className="col-span-12 w-t:col-span-8 w-p:col-span-4 mt-12 w-t:mt-6 w-p:mt-6">
          <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%]">{sections?.ourConventions?.title}</p>
        </div>
        {
      ...
      <ContentLayout classNames="mt-18 w-t:mt-6 w-p:mt-6">
        <div className="col-span-6 w-t:col-span-8 w-p:col-span-4 my-auto">
          <p className="font-headings font-bold text-10 w-t:text-6 w-p:text-6 leading-[125%] mb-6">{sections?.ourCertifications?.title}</p>
          <RichtText data={{
