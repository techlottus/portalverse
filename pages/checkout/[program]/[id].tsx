            ...
            <div className={cn("mobile:w-full flex justify-center min-h-[512px]", { 'hidden': activePageIndex !== 1 }, { 'w-full': flywireLink === "error" })}>
              {
                !flywireLink
                  ...
                  : flywireLink === "error"
                    ...
                    : <div className=" flex w-[500px] mobile:px-4 h-[700px] overflow-hidden overscroll-none pointer-events-none">
                      <iframe className="mobile:hidden tablet:hidden w-[500px] h-[200%] overflow-hidden overscroll-none -mt-[64px] -mb-1" src={flywireLink} title="Flywire form"></iframe>
