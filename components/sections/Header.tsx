                  ...
                  {menu_item?.items && menu_item?.items?.length > 0 && (
                    ...
                    >
                      ...
                      <div tabIndex={-1} onMouseLeave={() => {
                        ...
                        {subItems && openContent!=='closed' && open && <div className={classNames("desktop:hidden flex flex-col absolute top-0 left-0 w-full bg-surface-0 overflow-y-auto overscroll-auto h-full    ",{["hidden"]:!open, ["absolute z-30"]:open})}>
