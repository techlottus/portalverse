  ...
  return <section className={cn(classNames)}>
    ...
    <form>
      <div className={cn("flex flex-col", { "hidden": controlsConfig?.modality?.hidden })}>
        <p className="font-texts font-normal text-[14px] leading-5 text-[#282828] mt-6">{ config.modality }</p>
      ...
      <div className={cn("flex flex-col", { "hidden": controlsConfig?.level?.hidden })}>
        <p className="font-texts font-normal text-[14px] leading-5 text-[#282828] mt-6 mb-1">{ config.level }</p>
      ...
      <div className={cn("flex flex-col", { "hidden": controlsConfig?.program?.hidden })}>
        <p className="font-texts font-normal text-[14px] leading-5 text-[#282828] mt-6">{ config.program }</p>
      ...
      <div className={cn("flex flex-col", { "hidden": controlsConfig?.campus?.hidden })}>
        <p className="font-texts font-normal text-[14px] leading-5 text-[#282828] mt-6">{ config.campus }</p>
