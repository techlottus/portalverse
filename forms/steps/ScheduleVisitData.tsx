...
const ScheduleVisitData: FC<any> = ({
  ...
  const handleKeyPress = (e: CustomEvent, control: string) => {
    ...
    setScheduleVist({ ...scheduleVist, [control]: value });
  ...
  const handleSelect = (e: CustomEvent, control: string) => {
    ...
    setInfoControlsTouched({ ...infoControlsTouched, [control]: true });
    setScheduleVist({ ...scheduleVist, [control]: detail });
  ...
  const handleTouchedControl = (control: string) => {
    setInfoControlsTouched({ ...infoControlsTouched, [control]: true });
    setErrorControls({ ...errorControls, [control]: !validateControl(control, scheduleVist[control], true) && infoControlsTouched[control] });
  }
  ...
  return <>
    ...
    <div className={cn("flex flex-col", { '': Options?.levels?.length > 0 && Options?.levels?.length < 2 })}>
      ...
      <Select
        ...
        data={{ ...SelectInit, textDefault: `Elige un nivel`, icon: "", disabled: !scheduleVist?.modality }}
      />
    ...
    <div className="flex flex-col">
      ...
      <Select
        ...
        data={{ ...SelectInit, textDefault: `Elige un ${campusLabel}`, icon: "apartment", disabled: !scheduleVist?.level && !scheduleVist?.modality }}
      />
