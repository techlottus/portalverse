  ...
  return <>
    {
      ...
      <div className={cn("flex flex-col", {'hidden': optModalities?.length > 0 && optModalities?.length < 2 })}>
        <p className="font-texts font-normal text-sm leading-5 text-surface-800 mt-3 capitalize">Modalidad</p>
      ...
      <div className={cn("flex flex-col", {'hidden': optLevels?.length > 0 && optLevels?.length < 2 })}>
        <p className="font-texts font-normal text-sm leading-5 text-surface-800 mt-3 capitalize">Nivel</p>
      ...
      <div className="flex flex-col">
        <p className="font-texts font-normal text-sm leading-5 text-surface-800 mt-3 capitalize">{campusLabel || config?.campus}</p>
