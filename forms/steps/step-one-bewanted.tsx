...
const StepOne = ( { onNext, copies }: any ) => {
  ...
  return <section>
    <h1 className="font-headings font-semibold text-[22px] leading-7 mb-6">{ copies.title }</h1>
    <p className="font-texts font-normal text-sm leading-[17.5px]">{ copies.description }</p>
    <form>
