      ...
      <li 
       ...
       {pages.map((page) => (
         <li
            ...
            key={page}
            className={page === currentPage ? "flex justify-center items-center w-10 h-10 rounded-lg border-[1px] border-solid border-black cursor-pointer bg-black text-surface-0 m-2" : "flex justify-center items-center w-10 h-10 rounded-lg cursor-pointer m-2 hover:bg-SC-Actions-AC-200"}
          >
